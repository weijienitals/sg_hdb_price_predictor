...
for idx, row in worst.iterrows():
    print(f"   Actual: ${row['actual']:,.0f} | Predicted: ${row['predicted']:,.0f} | Error: ${row['error']:,.0f} ({row['percentage_error']:.1f}%)")
...
print("\n✅ Files saved:")
print("   - hdb_model.pkl (optimized model)")
print("   - baseline_model.pkl (baseline for comparison)")
